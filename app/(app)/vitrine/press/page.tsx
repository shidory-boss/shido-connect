...
const PRESS_ARTICLES = [
  {
    ...
    initials: 'FM',
    color: '#0066CC',
    title: 'Oria Care révolutionne la relation patient-médecin en Côte d\'Ivoire',
    excerpt: 'La startup abidjanaise Oria Care propose une application mobile qui permet aux patients de suivre leurs rendez-vous, consulter leurs ordonnances et communiquer avec leur médecin en temps réel.',
    date: '12 juin 2026',
    url: '#',
  },
  {
    ...
    excerpt: 'De plus en plus d\'établissements de santé en Côte d\'Ivoire s\'équipent de solutions numériques pour améliorer la qualité des soins. Oria Care figure parmi les pionniers de cette transformation.',
    date: '3 juin 2026',
    url: '#',
  },
  {
    ...
    excerpt: 'Notre sélection des acteurs les plus prometteurs de la healthtech africaine. Oria Care, avec sa suite complète de gestion médicale, se distingue par son ancrage local et son ambition continentale.',
    date: '20 mai 2026',
    url: '#',
  },
]
